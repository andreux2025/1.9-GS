...
static_assert(sizeof(ItemInspectEvolutionChoiceEntry_C_ExecuteUbergraph_ItemInspectEvolutionChoiceEntry) == 0x000008, "Wrong size on ItemInspectEvolutionChoiceEntry_C_ExecuteUbergraph_ItemInspectEvolutionChoiceEntry");
...
static_assert(offsetof(ItemInspectEvolutionChoiceEntry_C_ExecuteUbergraph_ItemInspectEvolutionChoiceEntry, K2Node_Event_IsDesignTime) == 0x000004, "Member 'ItemInspectEvolutionChoiceEntry_C_ExecuteUbergraph_ItemInspectEvolutionChoiceEntry::K2Node_Event_IsDesignTime' has a wrong offset!");
