...
static_assert(sizeof(UMcpProfileGroup) == 0x0001B0, "Wrong size on UMcpProfileGroup");
...
static_assert(offsetof(UMcpProfileGroup, bSendProfileCommandRevisions) == 0x0001A0, "Member 'UMcpProfileGroup::bSendProfileCommandRevisions' has a wrong offset!");
