...
static_assert(offsetof(HUD_PickupItemWidget_C_InitializeItemData, K2Node_Select_Default) == 0x000014, "Member 'HUD_PickupItemWidget_C_InitializeItemData::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(HUD_PickupItemWidget_C_InitializeItemData, CallFunc_IsValid_ReturnValue2) == 0x000015, "Member 'HUD_PickupItemWidget_C_InitializeItemData::CallFunc_IsValid_ReturnValue2' has a wrong offset!");
