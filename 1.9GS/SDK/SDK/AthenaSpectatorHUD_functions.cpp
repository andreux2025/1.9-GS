...
void UAthenaSpectatorHUD_C::GamePhaseChanged(EAthenaGamePhase GamePhase)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaSpectatorHUD_C", "GamePhaseChanged");

	Params::AthenaSpectatorHUD_C_GamePhaseChanged Parms{};
...
void UAthenaSpectatorHUD_C::ShowGameOverLayer()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaSpectatorHUD_C", "ShowGameOverLayer");
...
void UAthenaSpectatorHUD_C::SetCursorModeContent(class UUserWidget* CustomWidget, class FName& ActionName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaSpectatorHUD_C", "SetCursorModeContent");

	Params::AthenaSpectatorHUD_C_SetCursorModeContent Parms{};
