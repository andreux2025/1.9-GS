...
void UAthenaDeathWidget_C::BndEvt__OpenShadowPlayHighlights_K2Node_ComponentBoundEvent_188_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AthenaDeathWidget_C", "BndEvt__OpenShadowPlayHighlights_K2Node_ComponentBoundEvent_188_CommonButtonClicked__DelegateSignature");

	Params::AthenaDeathWidget_C_BndEvt__OpenShadowPlayHighlights_K2Node_ComponentBoundEvent_188_CommonButtonClicked__DelegateSignature Parms{};
...
void UAthenaDeathWidget_C::HighlightCountChanged(int32 HighlightCount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaDeathWidget_C", "HighlightCountChanged");

	Params::AthenaDeathWidget_C_HighlightCountChanged Parms{};
...
void UAthenaDeathWidget_C::UpdateYouPlacedBoxVisibility()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaDeathWidget_C", "UpdateYouPlacedBoxVisibility");
