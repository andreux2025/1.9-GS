...
void UItemManagementScreen_C::IsWritableWIFEAvailable(bool* bWritable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementScreen_C", "IsWritableWIFEAvailable");

	Params::ItemManagementScreen_C_IsWritableWIFEAvailable Parms{};
