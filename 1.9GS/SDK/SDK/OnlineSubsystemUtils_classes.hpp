...
public:
	...
	{
		void (*_PauseBeaconRequests)(AOnlineBeacon * Beacon, bool bPause) = decltype(_PauseBeaconRequests)((uintptr_t)GetModuleHandleW(0) + 0x70f0f0);
		_PauseBeaconRequests(this, bPause);
	}
...
public:
	bool InitHost()
	{
		static bool (*_InitHost)(AOnlineBeaconHost * Beacon) = decltype(_InitHost)((uintptr_t)GetModuleHandleW(nullptr) + 0x3a499c0);
...
public:
	bool InitListen(void* InNotify, FURL& LocalURL, bool bReuseAddressAndPort, FString& Error)
	{
		static bool (*_InitListen)(UIpNetDriver * IpNetDriver, void* InNotify, FURL & LocalURL, bool bReuseAddressAndPort, FString & Error) = decltype(_InitListen)((uintptr_t)GetModuleHandleW(0) + 0x3a49da0);
		return _InitListen(this, InNotify, LocalURL, bReuseAddressAndPort, Error);
	}
