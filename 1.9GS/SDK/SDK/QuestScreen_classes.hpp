...
static_assert(sizeof(UQuestScreen_C) == 0x0004C0, "Wrong size on UQuestScreen_C");
...
static_assert(offsetof(UQuestScreen_C, AbandonQuest) == 0x0004B0, "Member 'UQuestScreen_C::AbandonQuest' has a wrong offset!");
