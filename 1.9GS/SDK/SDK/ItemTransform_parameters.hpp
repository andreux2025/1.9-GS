...
public:
	...
	bool                                          CallFunc_HandleClosePicker_PassThrough;            // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	int32                                         CallFunc_GetActiveWidgetIndex_ReturnValue2;        // 0x0098(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ItemTransform_C_ExecuteUbergraph_ItemTransform) == 0x0000A0, "Wrong size on ItemTransform_C_ExecuteUbergraph_ItemTransform");
...
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_HandleClosePicker_PassThrough) == 0x000004, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_HandleClosePicker_PassThrough' has a wrong offset!");
...
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_GetActiveWidgetIndex_ReturnValue2) == 0x000098, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_GetActiveWidgetIndex_ReturnValue2' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_EqualEqual_IntInt_ReturnValue2) == 0x00009C, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_EqualEqual_IntInt_ReturnValue2' has a wrong offset!");
