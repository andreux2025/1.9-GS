...
public:
	...
	int32                                         CallFunc_GetFPSForHUD_ReturnValue;                 // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPlayerControllerAthena*            K2Node_DynamicCast_AsFort_Player_Controller_Athena2; // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS) == 0x0000B0, "Wrong size on AthenaFPS_C_ExecuteUbergraph_AthenaFPS");
...
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_Event_InDeltaTime) == 0x00004C, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, CallFunc_GetOwningPlayer_ReturnValue) == 0x000050, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_DynamicCast_AsFort_Player_Controller_Athena) == 0x000058, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_DynamicCast_AsFort_Player_Controller_Athena' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_DynamicCast_bSuccess) == 0x000060, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, CallFunc_GetOwningPlayer_ReturnValue2) == 0x000068, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::CallFunc_GetOwningPlayer_ReturnValue2' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, CallFunc_GetFPSForHUD_ReturnValue) == 0x000070, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::CallFunc_GetFPSForHUD_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_DynamicCast_AsFort_Player_Controller_Athena2) == 0x000078, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_DynamicCast_AsFort_Player_Controller_Athena2' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_DynamicCast_bSuccess2) == 0x000080, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, CallFunc_BuildString_Int_ReturnValue) == 0x000088, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::CallFunc_BuildString_Int_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, CallFunc_Conv_StringToText_ReturnValue) == 0x000098, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AthenaFPS_C_Tick) == 0x000038, "Wrong size on AthenaFPS_C_Tick");
static_assert(offsetof(AthenaFPS_C_Tick, MyGeometry) == 0x000000, "Member 'AthenaFPS_C_Tick::MyGeometry' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_Tick, InDeltaTime) == 0x000034, "Member 'AthenaFPS_C_Tick::InDeltaTime' has a wrong offset!");
...
{
public:
	bool                                          bShowFPS;                                          // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
