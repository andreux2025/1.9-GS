...
public:
	...
	class UPrimitiveComponent*                    K2Node_Event_MyComp;                               // 0x0098(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_Other;                                // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    K2Node_Event_OtherComp;                            // 0x00A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_Event_Hit3;                                 // 0x00D8(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             K2Node_Event_Hit2;                                 // 0x0160(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
static_assert(offsetof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage, K2Node_Event_Hit3) == 0x0000D8, "Member 'B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage::K2Node_Event_Hit3' has a wrong offset!");
static_assert(offsetof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage, K2Node_Event_Hit2) == 0x000160, "Member 'B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage::K2Node_Event_Hit2' has a wrong offset!");
