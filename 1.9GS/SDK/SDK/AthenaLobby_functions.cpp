...
void UAthenaLobby_C::OnInput_ShowCustomMatchmakingKey(bool* bPassThrough)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLobby_C", "OnInput_ShowCustomMatchmakingKey");

	Params::AthenaLobby_C_OnInput_ShowCustomMatchmakingKey Parms{};
