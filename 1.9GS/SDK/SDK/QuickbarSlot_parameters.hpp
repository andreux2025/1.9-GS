...
static_assert(offsetof(QuickbarSlot_C_ExecuteUbergraph_QuickbarSlot, K2Node_Event_InDeltaTime) == 0x0000D4, "Member 'QuickbarSlot_C_ExecuteUbergraph_QuickbarSlot::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(QuickbarSlot_C_ExecuteUbergraph_QuickbarSlot, K2Node_SwitchEnum_CmpSuccess) == 0x0000D8, "Member 'QuickbarSlot_C_ExecuteUbergraph_QuickbarSlot::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(QuickbarSlot_C_ExecuteUbergraph_QuickbarSlot, K2Node_Event_IsDesignTime) == 0x0000D9, "Member 'QuickbarSlot_C_ExecuteUbergraph_QuickbarSlot::K2Node_Event_IsDesignTime' has a wrong offset!");
...
static_assert(sizeof(QuickbarSlot_C_Tick) == 0x000038, "Wrong size on QuickbarSlot_C_Tick");
static_assert(offsetof(QuickbarSlot_C_Tick, MyGeometry) == 0x000000, "Member 'QuickbarSlot_C_Tick::MyGeometry' has a wrong offset!");
static_assert(offsetof(QuickbarSlot_C_Tick, InDeltaTime) == 0x000034, "Member 'QuickbarSlot_C_Tick::InDeltaTime' has a wrong offset!");
