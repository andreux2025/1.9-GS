...
void UOptionsMenu_C::HandleTabGameOptionsResetButtonVisibility(int32 ActiveWidgetIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("OptionsMenu_C", "HandleTabGameOptionsResetButtonVisibility");

	Params::OptionsMenu_C_HandleTabGameOptionsResetButtonVisibility Parms{};
