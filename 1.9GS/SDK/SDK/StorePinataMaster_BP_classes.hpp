...
public:
	...
	class UMaterialInstanceDynamic*               MID_LlamaLeather;                                  // 0x0BD0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(AStorePinataMaster_BP_C, MID_LlamaLeather) == 0x000BD0, "Member 'AStorePinataMaster_BP_C::MID_LlamaLeather' has a wrong offset!");
