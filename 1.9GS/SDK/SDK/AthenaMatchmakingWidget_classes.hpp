...
static_assert(sizeof(UAthenaMatchmakingWidget_C) == 0x0002E8, "Wrong size on UAthenaMatchmakingWidget_C");
static_assert(offsetof(UAthenaMatchmakingWidget_C, UberGraphFrame) == 0x0002D8, "Member 'UAthenaMatchmakingWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaMatchmakingWidget_C, MatchmakingSpinner) == 0x0002E0, "Member 'UAthenaMatchmakingWidget_C::MatchmakingSpinner' has a wrong offset!");
