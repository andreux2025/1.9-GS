...
static_assert(offsetof(AthenaHitPointBar_C_ExecuteUbergraph_AthenaHitPointBar, K2Node_Event_InDeltaTime) == 0x0000BC, "Member 'AthenaHitPointBar_C_ExecuteUbergraph_AthenaHitPointBar::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(AthenaHitPointBar_C_ExecuteUbergraph_AthenaHitPointBar, K2Node_SwitchEnum2_CmpSuccess) == 0x0000C0, "Member 'AthenaHitPointBar_C_ExecuteUbergraph_AthenaHitPointBar::K2Node_SwitchEnum2_CmpSuccess' has a wrong offset!");
