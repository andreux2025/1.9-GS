...
static_assert(offsetof(UItemManagementInventoryLimitStatusIndicator_C, IsDeployableBase) == 0x000259, "Member 'UItemManagementInventoryLimitStatusIndicator_C::IsDeployableBase' has a wrong offset!");
static_assert(offsetof(UItemManagementInventoryLimitStatusIndicator_C, UseTypeSpecificLabel) == 0x00025A, "Member 'UItemManagementInventoryLimitStatusIndicator_C::UseTypeSpecificLabel' has a wrong offset!");
