...
static_assert(sizeof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag) == 0x000080, "Wrong size on EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag");
...
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, Temp_bool_Variable) == 0x000019, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_IsDedicatedServer_ReturnValue) == 0x00001A, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, Temp_int_Loop_Counter_Variable) == 0x000030, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::Temp_int_Loop_Counter_Variable' has a wrong offset!");
...
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_Map_Find_Value) == 0x000048, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_Map_Find_ReturnValue) == 0x000050, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_Add_IntInt_ReturnValue) == 0x000054, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_Array_Get_Item) == 0x000058, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_Array_Length_ReturnValue) == 0x000060, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_Conv_NameToString_ReturnValue) == 0x000068, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_Less_IntInt_ReturnValue) == 0x000078, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_BooleanAND_ReturnValue) == 0x000079, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag, CallFunc_Map_Contains_ReturnValue) == 0x00007A, "Member 'EnemyPawn_Parent_C_OverrideMaterialFromMapByMeshTag::CallFunc_Map_Contains_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap) == 0x000098, "Wrong size on EnemyPawn_Parent_C_OverwriteKeysInMaterialMap");
...
static_assert(offsetof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap, CallFunc_IsDedicatedServer_ReturnValue) == 0x00004C, "Member 'EnemyPawn_Parent_C_OverwriteKeysInMaterialMap::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap, CallFunc_Add_IntInt_ReturnValue) == 0x000050, "Member 'EnemyPawn_Parent_C_OverwriteKeysInMaterialMap::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap, CallFunc_Array_Get_Item) == 0x000058, "Member 'EnemyPawn_Parent_C_OverwriteKeysInMaterialMap::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap, CallFunc_Map_Keys_Keys) == 0x000060, "Member 'EnemyPawn_Parent_C_OverwriteKeysInMaterialMap::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap, CallFunc_IsValid_ReturnValue) == 0x000070, "Member 'EnemyPawn_Parent_C_OverwriteKeysInMaterialMap::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap, CallFunc_Map_Add_ReturnValue) == 0x000088, "Member 'EnemyPawn_Parent_C_OverwriteKeysInMaterialMap::CallFunc_Map_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap, CallFunc_Array_Length_ReturnValue) == 0x00008C, "Member 'EnemyPawn_Parent_C_OverwriteKeysInMaterialMap::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnemyPawn_Parent_C_OverwriteKeysInMaterialMap, CallFunc_Less_IntInt_ReturnValue) == 0x000090, "Member 'EnemyPawn_Parent_C_OverwriteKeysInMaterialMap::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
{
public:
	class UMaterialInterface*                     Material_To_Apply;                                 // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue;            // 0x0008(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
