...
static_assert(sizeof(ItemManagementInventoryLimitStatusIndicator_C_ExecuteUbergraph_ItemManagementInventoryLimitStatusIndicator) == 0x0000A8, "Wrong size on ItemManagementInventoryLimitStatusIndicator_C_ExecuteUbergraph_ItemManagementInventoryLimitStatusIndicator");
...
static_assert(offsetof(ItemManagementInventoryLimitStatusIndicator_C_ExecuteUbergraph_ItemManagementInventoryLimitStatusIndicator, CallFunc_GetContext_ReturnValue) == 0x000050, "Member 'ItemManagementInventoryLimitStatusIndicator_C_ExecuteUbergraph_ItemManagementInventoryLimitStatusIndicator::CallFunc_GetContext_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemManagementInventoryLimitStatusIndicator_C_ExecuteUbergraph_ItemManagementInventoryLimitStatusIndicator, CallFunc_GetContext_ReturnValue2) == 0x000080, "Member 'ItemManagementInventoryLimitStatusIndicator_C_ExecuteUbergraph_ItemManagementInventoryLimitStatusIndicator::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(ItemManagementInventoryLimitStatusIndicator_C_ExecuteUbergraph_ItemManagementInventoryLimitStatusIndicator, CallFunc_GetContext_ReturnValue3) == 0x0000A0, "Member 'ItemManagementInventoryLimitStatusIndicator_C_ExecuteUbergraph_ItemManagementInventoryLimitStatusIndicator::CallFunc_GetContext_ReturnValue3' has a wrong offset!");
...
static_assert(sizeof(ItemManagementInventoryLimitStatusIndicator_C_TrackStorageInventory) == 0x000038, "Wrong size on ItemManagementInventoryLimitStatusIndicator_C_TrackStorageInventory");
...
static_assert(offsetof(ItemManagementInventoryLimitStatusIndicator_C_TrackStorageInventory, CallFunc_GetCurrent_ReturnValue) == 0x000018, "Member 'ItemManagementInventoryLimitStatusIndicator_C_TrackStorageInventory::CallFunc_GetCurrent_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemManagementInventoryLimitStatusIndicator_C_TrackStorageInventory, CallFunc_IsValid_ReturnValue) == 0x000020, "Member 'ItemManagementInventoryLimitStatusIndicator_C_TrackStorageInventory::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemManagementInventoryLimitStatusIndicator_C_TrackStorageInventory, K2Node_CreateDelegate_OutputDelegate2) == 0x000028, "Member 'ItemManagementInventoryLimitStatusIndicator_C_TrackStorageInventory::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
...
{
public:
	int32                                         MaxCount;                                          // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
