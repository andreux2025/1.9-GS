...
static_assert(sizeof(AHBOnboardingFlow_C) == 0x000438, "Wrong size on AHBOnboardingFlow_C");
...
static_assert(offsetof(AHBOnboardingFlow_C, PlayHexsylvaniaMovieQuest) == 0x0003B0, "Member 'AHBOnboardingFlow_C::PlayHexsylvaniaMovieQuest' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, bPlayedHexsylvaniaMovie) == 0x0003B8, "Member 'AHBOnboardingFlow_C::bPlayedHexsylvaniaMovie' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, bHasRecheckedNeedToPlayEventMovie) == 0x0003B9, "Member 'AHBOnboardingFlow_C::bHasRecheckedNeedToPlayEventMovie' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, CompleteZoneObjective) == 0x0003C0, "Member 'AHBOnboardingFlow_C::CompleteZoneObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, NameHomebaseObjective) == 0x0003D0, "Member 'AHBOnboardingFlow_C::NameHomebaseObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, OnboardingQuestItem) == 0x0003E0, "Member 'AHBOnboardingFlow_C::OnboardingQuestItem' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, NotificationPadding) == 0x0003E8, "Member 'AHBOnboardingFlow_C::NotificationPadding' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, PlaySatelliteCineObjective) == 0x0003F8, "Member 'AHBOnboardingFlow_C::PlaySatelliteCineObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, ShowNewsToken) == 0x000408, "Member 'AHBOnboardingFlow_C::ShowNewsToken' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, ClientQuestLoginRetryCount) == 0x000410, "Member 'AHBOnboardingFlow_C::ClientQuestLoginRetryCount' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, ClientQuestLoginNumRetries) == 0x000414, "Member 'AHBOnboardingFlow_C::ClientQuestLoginNumRetries' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, PlayHexsylvaniaCineObjective) == 0x000418, "Member 'AHBOnboardingFlow_C::PlayHexsylvaniaCineObjective' has a wrong offset!");
static_assert(offsetof(AHBOnboardingFlow_C, StormShieldDefenseObjective) == 0x000428, "Member 'AHBOnboardingFlow_C::StormShieldDefenseObjective' has a wrong offset!");
