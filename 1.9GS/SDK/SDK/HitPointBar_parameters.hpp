...
public:
	...
	TDelegate<void(float HitPointValue, EFortHitPointModificationReason ModificationReason)> K2Node_CreateDelegate_OutputDelegate2;             // 0x0018(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(HitPointBar_C_ExecuteUbergraph_HitPointBar) == 0x000080, "Wrong size on HitPointBar_C_ExecuteUbergraph_HitPointBar");
...
static_assert(offsetof(HitPointBar_C_ExecuteUbergraph_HitPointBar, K2Node_Event_IsDesignTime) == 0x000031, "Member 'HitPointBar_C_ExecuteUbergraph_HitPointBar::K2Node_Event_IsDesignTime' has a wrong offset!");
...
static_assert(offsetof(HitPointBar_C_ExecuteUbergraph_HitPointBar, K2Node_Event_MyGeometry) == 0x000048, "Member 'HitPointBar_C_ExecuteUbergraph_HitPointBar::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_ExecuteUbergraph_HitPointBar, K2Node_Event_InDeltaTime) == 0x00007C, "Member 'HitPointBar_C_ExecuteUbergraph_HitPointBar::K2Node_Event_InDeltaTime' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_GetMaxShield_ReturnValue;                 // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetMaxStamina_ReturnValue;                // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetStamina_ReturnValue;                   // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(HitPointBar_C_SetInitialValues) == 0x000040, "Wrong size on HitPointBar_C_SetInitialValues");
static_assert(offsetof(HitPointBar_C_SetInitialValues, K2Node_SwitchEnum_CmpSuccess) == 0x000000, "Member 'HitPointBar_C_SetInitialValues::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetPlayerController_ReturnValue) == 0x000008, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_K2_GetPawn_ReturnValue) == 0x000010, "Member 'HitPointBar_C_SetInitialValues::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, K2Node_DynamicCast_AsFort_Player_Pawn) == 0x000018, "Member 'HitPointBar_C_SetInitialValues::K2Node_DynamicCast_AsFort_Player_Pawn' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'HitPointBar_C_SetInitialValues::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetMaxShield_ReturnValue) == 0x000024, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetMaxShield_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetMaxStamina_ReturnValue) == 0x000028, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetMaxStamina_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetStamina_ReturnValue) == 0x00002C, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetStamina_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetMaxHealth_ReturnValue) == 0x000030, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetMaxHealth_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetHealth_ReturnValue) == 0x000034, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetHealth_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetShield_ReturnValue) == 0x000038, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetShield_ReturnValue' has a wrong offset!");
