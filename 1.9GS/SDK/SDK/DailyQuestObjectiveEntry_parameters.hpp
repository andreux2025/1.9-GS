...
public:
	...
	ESlateVisibility                              Temp_byte_Variable;                                // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              Temp_byte_Variable2;                               // 0x0032(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(DailyQuestObjectiveEntry_C_Update) == 0x000060, "Wrong size on DailyQuestObjectiveEntry_C_Update");
...
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, CallFunc_SpawnTooltipContext_ReturnValue) == 0x000010, "Member 'DailyQuestObjectiveEntry_C_Update::CallFunc_SpawnTooltipContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, CallFunc_GetText_ReturnValue) == 0x000018, "Member 'DailyQuestObjectiveEntry_C_Update::CallFunc_GetText_ReturnValue' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, CallFunc_TextIsEmpty_ReturnValue) == 0x000030, "Member 'DailyQuestObjectiveEntry_C_Update::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, Temp_byte_Variable) == 0x000031, "Member 'DailyQuestObjectiveEntry_C_Update::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, Temp_byte_Variable2) == 0x000032, "Member 'DailyQuestObjectiveEntry_C_Update::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, Temp_bool_Variable) == 0x000033, "Member 'DailyQuestObjectiveEntry_C_Update::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, CallFunc_GetContext_ReturnValue) == 0x000038, "Member 'DailyQuestObjectiveEntry_C_Update::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, CallFunc_GetCombinedDescription_OutDescription) == 0x000040, "Member 'DailyQuestObjectiveEntry_C_Update::CallFunc_GetCombinedDescription_OutDescription' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, CallFunc_GetCombinedDescription_ReturnValue) == 0x000058, "Member 'DailyQuestObjectiveEntry_C_Update::CallFunc_GetCombinedDescription_ReturnValue' has a wrong offset!");
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, K2Node_Select_Default) == 0x000059, "Member 'DailyQuestObjectiveEntry_C_Update::K2Node_Select_Default' has a wrong offset!");
...
{
public:
	struct FFortMcpQuestObjectiveInfo             ObjectiveInfo;                                     // 0x0000(0x00F8)(Parm)
};
...
static_assert(sizeof(DailyQuestObjectiveEntry_C_UpdateFromObjectiveInfo) == 0x0000F8, "Wrong size on DailyQuestObjectiveEntry_C_UpdateFromObjectiveInfo");
