...
public:
	...
	class USkeletalMeshComponent*                 DuplicateCharacterMesh;                            // 0x1EB8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*               DuplicateCharacterMID;                             // 0x1EC0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AEnemyPawn_Parent_C) == 0x001ED0, "Wrong size on AEnemyPawn_Parent_C");
...
static_assert(offsetof(AEnemyPawn_Parent_C, CharacterElementalParticles) == 0x001C90, "Member 'AEnemyPawn_Parent_C::CharacterElementalParticles' has a wrong offset!");
...
static_assert(offsetof(AEnemyPawn_Parent_C, SpecialEventHalloweenPumpkinHeadApplied) == 0x001CE1, "Member 'AEnemyPawn_Parent_C::SpecialEventHalloweenPumpkinHeadApplied' has a wrong offset!");
...
static_assert(offsetof(AEnemyPawn_Parent_C, TC_SpecialEventHalloweenPumpkinHead) == 0x001D08, "Member 'AEnemyPawn_Parent_C::TC_SpecialEventHalloweenPumpkinHead' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, PumpkinHeadPercentage) == 0x001D28, "Member 'AEnemyPawn_Parent_C::PumpkinHeadPercentage' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, GE_SpecialEvent_Halloween_PumpkinHead) == 0x001D30, "Member 'AEnemyPawn_Parent_C::GE_SpecialEvent_Halloween_PumpkinHead' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Pumpkin_Head_Mesh) == 0x001D38, "Member 'AEnemyPawn_Parent_C::Pumpkin_Head_Mesh' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Pumpkin_Eyeglow_Mesh) == 0x001D40, "Member 'AEnemyPawn_Parent_C::Pumpkin_Eyeglow_Mesh' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, PumpkinHeadRotation) == 0x001D48, "Member 'AEnemyPawn_Parent_C::PumpkinHeadRotation' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, PumpkinHeadScale) == 0x001D54, "Member 'AEnemyPawn_Parent_C::PumpkinHeadScale' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, PumpkinHeadOffset) == 0x001D60, "Member 'AEnemyPawn_Parent_C::PumpkinHeadOffset' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, PumpkinEyesFX) == 0x001D70, "Member 'AEnemyPawn_Parent_C::PumpkinEyesFX' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Headshot_FX_Socket) == 0x001D78, "Member 'AEnemyPawn_Parent_C::Headshot_FX_Socket' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Material_Alteration_0) == 0x001D80, "Member 'AEnemyPawn_Parent_C::Material_Alteration_0' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Material_Alteration_1) == 0x001D88, "Member 'AEnemyPawn_Parent_C::Material_Alteration_1' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, SleepParticleSystemComp) == 0x001D90, "Member 'AEnemyPawn_Parent_C::SleepParticleSystemComp' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Husk_Sleeping_Sound) == 0x001D98, "Member 'AEnemyPawn_Parent_C::Husk_Sleeping_Sound' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, HuskSleepSound) == 0x001DA0, "Member 'AEnemyPawn_Parent_C::HuskSleepSound' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, WakeUpParticleSystemComp) == 0x001DA8, "Member 'AEnemyPawn_Parent_C::WakeUpParticleSystemComp' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, AwokenMaxDistance) == 0x001DB0, "Member 'AEnemyPawn_Parent_C::AwokenMaxDistance' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, AwokenSkeletalMesh) == 0x001DB8, "Member 'AEnemyPawn_Parent_C::AwokenSkeletalMesh' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, AwokenSkelMeshMID) == 0x001DC0, "Member 'AEnemyPawn_Parent_C::AwokenSkelMeshMID' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, AwokenFadeInTime) == 0x001DC8, "Member 'AEnemyPawn_Parent_C::AwokenFadeInTime' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, AwokenFadeOutTime) == 0x001DCC, "Member 'AEnemyPawn_Parent_C::AwokenFadeOutTime' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, AwokenDuration) == 0x001DD0, "Member 'AEnemyPawn_Parent_C::AwokenDuration' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Sleeping) == 0x001DD4, "Member 'AEnemyPawn_Parent_C::Sleeping' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, HasGlowColorsAssigned) == 0x001DD5, "Member 'AEnemyPawn_Parent_C::HasGlowColorsAssigned' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, SpawnInTimelineCompletedSuccessfully) == 0x001DD6, "Member 'AEnemyPawn_Parent_C::SpawnInTimelineCompletedSuccessfully' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, CharacterSpawnInSafetyCheckHandle) == 0x001DD8, "Member 'AEnemyPawn_Parent_C::CharacterSpawnInSafetyCheckHandle' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Base_MID_0) == 0x001DE0, "Member 'AEnemyPawn_Parent_C::Base_MID_0' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, Previous_MID_0) == 0x001DE8, "Member 'AEnemyPawn_Parent_C::Previous_MID_0' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, CharacterElementalParticlesTemplate) == 0x001DF0, "Member 'AEnemyPawn_Parent_C::CharacterElementalParticlesTemplate' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, FrozenHuskMeshScale) == 0x001DF8, "Member 'AEnemyPawn_Parent_C::FrozenHuskMeshScale' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, SpawnFrozenHuskMesh) == 0x001E04, "Member 'AEnemyPawn_Parent_C::SpawnFrozenHuskMesh' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, CharacterAmbientParticlesTemplate) == 0x001E08, "Member 'AEnemyPawn_Parent_C::CharacterAmbientParticlesTemplate' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, CharacterAmbientParticles) == 0x001E10, "Member 'AEnemyPawn_Parent_C::CharacterAmbientParticles' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, MaterialModifierMap) == 0x001E18, "Member 'AEnemyPawn_Parent_C::MaterialModifierMap' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, MaterialModifierMapDefaults) == 0x001E68, "Member 'AEnemyPawn_Parent_C::MaterialModifierMapDefaults' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, DuplicateCharacterMesh) == 0x001EB8, "Member 'AEnemyPawn_Parent_C::DuplicateCharacterMesh' has a wrong offset!");
static_assert(offsetof(AEnemyPawn_Parent_C, DuplicateCharacterMID) == 0x001EC0, "Member 'AEnemyPawn_Parent_C::DuplicateCharacterMID' has a wrong offset!");
