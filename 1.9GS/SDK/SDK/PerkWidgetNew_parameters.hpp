...
static_assert(sizeof(PerkWidgetNew_C_InitializeBasicPerk) == 0x0001C0, "Wrong size on PerkWidgetNew_C_InitializeBasicPerk");
...
static_assert(sizeof(PerkWidgetNew_C_InitializeAbilityPerk) == 0x0001C0, "Wrong size on PerkWidgetNew_C_InitializeAbilityPerk");
