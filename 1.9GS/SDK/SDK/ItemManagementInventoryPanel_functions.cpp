...
void UItemManagementInventoryPanel_C::IsWritableWIFEAvailable(bool* WritableWIFE)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ItemManagementInventoryPanel_C", "IsWritableWIFEAvailable");

	Params::ItemManagementInventoryPanel_C_IsWritableWIFEAvailable Parms{};
