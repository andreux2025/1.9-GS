...
public:
	...
	class USizeBox*                               SizeBox_Inventory;                                 // 0x0728(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class USizeBox*                               SizeBox_Screen;                                    // 0x0730(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	bool                                          ItemDragEnabled;                                   // 0x0738(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_739[0x7];                                      // 0x0739(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortItemManagementItemTileButton*      SelectedTileButton;                                // 0x0740(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UQuantitySelector_C*                    QuantitySelectorWidget;                            // 0x0748(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UItemManagementScreen_C) == 0x000750, "Wrong size on UItemManagementScreen_C");
static_assert(offsetof(UItemManagementScreen_C, UberGraphFrame) == 0x000720, "Member 'UItemManagementScreen_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemManagementScreen_C, SizeBox_Inventory) == 0x000728, "Member 'UItemManagementScreen_C::SizeBox_Inventory' has a wrong offset!");
static_assert(offsetof(UItemManagementScreen_C, SizeBox_Screen) == 0x000730, "Member 'UItemManagementScreen_C::SizeBox_Screen' has a wrong offset!");
static_assert(offsetof(UItemManagementScreen_C, ItemDragEnabled) == 0x000738, "Member 'UItemManagementScreen_C::ItemDragEnabled' has a wrong offset!");
static_assert(offsetof(UItemManagementScreen_C, SelectedTileButton) == 0x000740, "Member 'UItemManagementScreen_C::SelectedTileButton' has a wrong offset!");
static_assert(offsetof(UItemManagementScreen_C, QuantitySelectorWidget) == 0x000748, "Member 'UItemManagementScreen_C::QuantitySelectorWidget' has a wrong offset!");
