...
static_assert(sizeof(ZoneDetails_C_Update) == 0x000488, "Wrong size on ZoneDetails_C_Update");
...
static_assert(offsetof(ZoneDetails_C_Update, CallFunc_TextToUpper_ReturnValue) == 0x000458, "Member 'ZoneDetails_C_Update::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
static_assert(offsetof(ZoneDetails_C_Update, CallFunc_Format_ReturnValue) == 0x000470, "Member 'ZoneDetails_C_Update::CallFunc_Format_ReturnValue' has a wrong offset!");
