...
static_assert(sizeof(ItemCalledOutAttributesDetailWidget_C_UpdateStats) == 0x000158, "Wrong size on ItemCalledOutAttributesDetailWidget_C_UpdateStats");
...
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Array_Length_ReturnValue2) == 0x0000D4, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Array_Length_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Less_IntInt_ReturnValue) == 0x000148, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Array_Length_ReturnValue3) == 0x00014C, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Array_Length_ReturnValue3' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Array_Length_ReturnValue4) == 0x000150, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Array_Length_ReturnValue4' has a wrong offset!");
...
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000155, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
