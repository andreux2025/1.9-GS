...
public:
	...
	struct FUniqueNetIdRepl                       CallFunc_GetUniqueID_ReturnValue;                  // 0x0068(0x0018)(HasGetValueTypeHash)
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData;              // 0x0080(0x0040)(HasGetValueTypeHash)
	bool                                          CallFunc_AreUniqueIDsIdentical_ReturnValue;        // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(PlayerZoneTeamScoreContributionWidget_C_Initialize) == 0x0000F0, "Wrong size on PlayerZoneTeamScoreContributionWidget_C_Initialize");
...
static_assert(offsetof(PlayerZoneTeamScoreContributionWidget_C_Initialize, CallFunc_GetPlayerName_ReturnValue) == 0x000040, "Member 'PlayerZoneTeamScoreContributionWidget_C_Initialize::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerZoneTeamScoreContributionWidget_C_Initialize, CallFunc_Conv_StringToText_ReturnValue) == 0x000050, "Member 'PlayerZoneTeamScoreContributionWidget_C_Initialize::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerZoneTeamScoreContributionWidget_C_Initialize, CallFunc_GetUniqueID_ReturnValue) == 0x000068, "Member 'PlayerZoneTeamScoreContributionWidget_C_Initialize::CallFunc_GetUniqueID_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerZoneTeamScoreContributionWidget_C_Initialize, K2Node_MakeStruct_FormatArgumentData) == 0x000080, "Member 'PlayerZoneTeamScoreContributionWidget_C_Initialize::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(PlayerZoneTeamScoreContributionWidget_C_Initialize, CallFunc_AreUniqueIDsIdentical_ReturnValue) == 0x0000C0, "Member 'PlayerZoneTeamScoreContributionWidget_C_Initialize::CallFunc_AreUniqueIDsIdentical_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PlayerZoneTeamScoreContributionWidget_C_Initialize, CallFunc_Format_ReturnValue) == 0x0000D8, "Member 'PlayerZoneTeamScoreContributionWidget_C_Initialize::CallFunc_Format_ReturnValue' has a wrong offset!");
