...
public:
	...
	EInputActionState                             CallFunc_Get_Purchase_Slot_State_ReturnValue;      // 0x0259(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EInputActionState                             CallFunc_Get_Purchase_Slot_State_ReturnValue2;     // 0x025A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EInputActionState                             CallFunc_Get_Purchase_Slot_State_ReturnValue3;     // 0x025B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(BP_FortExpeditionBuildSquadWidget_C_ExecuteUbergraph_BP_FortExpeditionBuildSquadWidget, CallFunc_Get_Purchase_Slot_State_ReturnValue) == 0x000259, "Member 'BP_FortExpeditionBuildSquadWidget_C_ExecuteUbergraph_BP_FortExpeditionBuildSquadWidget::CallFunc_Get_Purchase_Slot_State_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionBuildSquadWidget_C_ExecuteUbergraph_BP_FortExpeditionBuildSquadWidget, CallFunc_Get_Purchase_Slot_State_ReturnValue2) == 0x00025A, "Member 'BP_FortExpeditionBuildSquadWidget_C_ExecuteUbergraph_BP_FortExpeditionBuildSquadWidget::CallFunc_Get_Purchase_Slot_State_ReturnValue2' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionBuildSquadWidget_C_ExecuteUbergraph_BP_FortExpeditionBuildSquadWidget, CallFunc_Get_Purchase_Slot_State_ReturnValue3) == 0x00025B, "Member 'BP_FortExpeditionBuildSquadWidget_C_ExecuteUbergraph_BP_FortExpeditionBuildSquadWidget::CallFunc_Get_Purchase_Slot_State_ReturnValue3' has a wrong offset!");
