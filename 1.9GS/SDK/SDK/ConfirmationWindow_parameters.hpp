...
static_assert(offsetof(ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow, CallFunc_GetUINavigationManager_ReturnValue) == 0x000008, "Member 'ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow::CallFunc_GetUINavigationManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow, K2Node_CreateDelegate_OutputDelegate2) == 0x000020, "Member 'ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow, K2Node_Event_IsDesignTime) == 0x000030, "Member 'ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000038, "Member 'ConfirmationWindow_C_ExecuteUbergraph_ConfirmationWindow::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
