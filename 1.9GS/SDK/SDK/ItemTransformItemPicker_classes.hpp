...
static_assert(offsetof(UItemTransformItemPicker_C, ItemTransformSlotItemPicker) == 0x000248, "Member 'UItemTransformItemPicker_C::ItemTransformSlotItemPicker' has a wrong offset!");
static_assert(offsetof(UItemTransformItemPicker_C, MainModeItemDetailsHostPanel) == 0x000250, "Member 'UItemTransformItemPicker_C::MainModeItemDetailsHostPanel' has a wrong offset!");
