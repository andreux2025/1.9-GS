...
public:
	...
	TArray<class UAthenaTeamMemberInfo_C*>        TeamMembers;                                       // 0x0278(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
...
static_assert(sizeof(UAthenaTeamInfo_C) == 0x000288, "Wrong size on UAthenaTeamInfo_C");
...
static_assert(offsetof(UAthenaTeamInfo_C, InvalidationBox_0) == 0x000270, "Member 'UAthenaTeamInfo_C::InvalidationBox_0' has a wrong offset!");
static_assert(offsetof(UAthenaTeamInfo_C, TeamMembers) == 0x000278, "Member 'UAthenaTeamInfo_C::TeamMembers' has a wrong offset!");
