...
static_assert(sizeof(XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText) == 0x000058, "Wrong size on XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText");
...
static_assert(offsetof(XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText, K2Node_CustomEvent_BoostAmount) == 0x000054, "Member 'XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText::K2Node_CustomEvent_BoostAmount' has a wrong offset!");
...
static_assert(sizeof(XpBoostInfoText_C_HandleAccountUpdate) == 0x000024, "Wrong size on XpBoostInfoText_C_HandleAccountUpdate");
