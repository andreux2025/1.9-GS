...
public:
	...
	TArray<class FText>                           K2Node_MakeArray_Array2;                           // 0x0040(0x0010)(ZeroConstructor, ReferenceParm)
	class FText                                   CallFunc_MakeLiteralText_ReturnValue3;             // 0x0050(0x0018)()
	class FText                                   CallFunc_MakeLiteralText_ReturnValue4;             // 0x0068(0x0018)()
	bool                                          CallFunc_ShowChatVolume_ReturnValue;               // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_ShowQuality_ReturnValue;                  // 0x0081(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_82[0x6];                                       // 0x0082(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_MakeLiteralText_ReturnValue5;             // 0x0088(0x0018)()
	TArray<class FText>                           K2Node_MakeArray_Array3;                           // 0x00A0(0x0010)(ZeroConstructor, ReferenceParm)
	class FText                                   CallFunc_MakeLiteralText_ReturnValue6;             // 0x00B0(0x0018)()
...
static_assert(sizeof(TabAudioOptions_C_InitializeData) == 0x000108, "Wrong size on TabAudioOptions_C_InitializeData");
static_assert(offsetof(TabAudioOptions_C_InitializeData, K2Node_MakeArray_Array) == 0x000000, "Member 'TabAudioOptions_C_InitializeData::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, CallFunc_MakeLiteralText_ReturnValue) == 0x000010, "Member 'TabAudioOptions_C_InitializeData::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, CallFunc_MakeLiteralText_ReturnValue2) == 0x000028, "Member 'TabAudioOptions_C_InitializeData::CallFunc_MakeLiteralText_ReturnValue2' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, K2Node_MakeArray_Array2) == 0x000040, "Member 'TabAudioOptions_C_InitializeData::K2Node_MakeArray_Array2' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, CallFunc_MakeLiteralText_ReturnValue3) == 0x000050, "Member 'TabAudioOptions_C_InitializeData::CallFunc_MakeLiteralText_ReturnValue3' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, CallFunc_MakeLiteralText_ReturnValue4) == 0x000068, "Member 'TabAudioOptions_C_InitializeData::CallFunc_MakeLiteralText_ReturnValue4' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, CallFunc_ShowChatVolume_ReturnValue) == 0x000080, "Member 'TabAudioOptions_C_InitializeData::CallFunc_ShowChatVolume_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, CallFunc_ShowQuality_ReturnValue) == 0x000081, "Member 'TabAudioOptions_C_InitializeData::CallFunc_ShowQuality_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, CallFunc_MakeLiteralText_ReturnValue5) == 0x000088, "Member 'TabAudioOptions_C_InitializeData::CallFunc_MakeLiteralText_ReturnValue5' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, K2Node_MakeArray_Array3) == 0x0000A0, "Member 'TabAudioOptions_C_InitializeData::K2Node_MakeArray_Array3' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeData, CallFunc_MakeLiteralText_ReturnValue6) == 0x0000B0, "Member 'TabAudioOptions_C_InitializeData::CallFunc_MakeLiteralText_ReturnValue6' has a wrong offset!");
...
// Function TabAudioOptions.TabAudioOptions_C.InitializeVoiceOptionsVisibility
// 0x0028 (0x0028 - 0x0000)
struct TabAudioOptions_C_InitializeVoiceOptionsVisibility final
{
public:
	...
	ESubGame                                      CallFunc_GetSubGame_ReturnValue;                   // 0x0011(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	ESubGame                                      Temp_byte_Variable6;                               // 0x0016(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	ESubGame                                      CallFunc_GetSubGame_ReturnValue2;                  // 0x0021(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	ESlateVisibility                              K2Node_Select2_Default;                            // 0x0026(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(TabAudioOptions_C_InitializeVoiceOptionsVisibility) == 0x000008, "Wrong alignment on TabAudioOptions_C_InitializeVoiceOptionsVisibility");
static_assert(sizeof(TabAudioOptions_C_InitializeVoiceOptionsVisibility) == 0x000028, "Wrong size on TabAudioOptions_C_InitializeVoiceOptionsVisibility");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, Temp_byte_Variable) == 0x000000, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, Temp_byte_Variable2) == 0x000001, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, Temp_bool_Variable) == 0x000010, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_GetSubGame_ReturnValue) == 0x000011, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_GetSubGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, Temp_byte_Variable3) == 0x000012, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::Temp_byte_Variable3' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000013, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, Temp_byte_Variable4) == 0x000014, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::Temp_byte_Variable4' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, Temp_byte_Variable5) == 0x000015, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::Temp_byte_Variable5' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, Temp_byte_Variable6) == 0x000016, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::Temp_byte_Variable6' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_GetContext_ReturnValue2) == 0x000018, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_IsPS4Platform_ReturnValue) == 0x000020, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_IsPS4Platform_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_GetSubGame_ReturnValue2) == 0x000021, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_GetSubGame_ReturnValue2' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_IsXboxPlatform_ReturnValue) == 0x000022, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_IsXboxPlatform_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_BooleanOR_ReturnValue) == 0x000023, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, K2Node_Select_Default) == 0x000024, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, CallFunc_BooleanOR_ReturnValue2) == 0x000025, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::CallFunc_BooleanOR_ReturnValue2' has a wrong offset!");
static_assert(offsetof(TabAudioOptions_C_InitializeVoiceOptionsVisibility, K2Node_Select2_Default) == 0x000026, "Member 'TabAudioOptions_C_InitializeVoiceOptionsVisibility::K2Node_Select2_Default' has a wrong offset!");
